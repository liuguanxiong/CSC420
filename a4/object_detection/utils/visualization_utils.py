...
def visualize_boxes_and_labels_on_image_array(
  ...
  for i in range(min(max_boxes_to_draw, boxes.shape[0])):
    if 'name' in category_index[classes[i]]:
        class_name = category_index[classes[i]]['name']
    if scores is None or (scores[i] > min_score_thresh and (class_name == 'person' or class_name == 'bicycle' or class_name == 'car' or class_name == 'traffic light')):
